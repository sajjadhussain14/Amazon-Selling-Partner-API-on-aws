<cfcomponent displayname="AWS" output="true" hint="Handle the application.">

    <!--- Set up the application. --->
    <cfset THIS.Name = "AWS Integration" />
...
<cfscript>
    ...
    <cffunction name="OnApplicationStart" access="public"  output="false" hint="Fires when the application is first created.">
        ...
        <cfscript>
            ...
            // AWS API CREDENTIALS 
            application.accessKeyId = "Your access key"; 
            application.secretAccessKey = "Your access key secret";

            application.refresh_token='Your refresh initial token'

            application.client_id = "your client id"; 
            application.client_secret = "your client secret"; 
