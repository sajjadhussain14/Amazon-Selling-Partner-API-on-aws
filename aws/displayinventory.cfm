...
<cfscript>
	...
	args.updateTargetUrl='https://sandbox.sellingpartnerapi-na.amazon.com/externalFulfillment/inventory/2021-01-06/locations/43cd8cd4-a944-4fa8-a584-5e3b3efdb045/skus/efptestsku2'
	// Get Access and Refresh Data
	args.tokens=externalFulfillment.getToken(amzDate)
	updateInventoryRes=inventory.getInventory(args.updateTargetUrl,args.tokens.access_token,amzDate,signatureData.authHeader)
